...
import com.club.service.FinanceRecordService;
...
public class FinanceRecordController {
    ...
    @PostMapping
    public Result create(@RequestBody FinanceRecord body) {
        service.create(body);
        return Result.success();
    }

    @PutMapping("/{id}")
    public Result update(@PathVariable Integer id, @RequestBody FinanceRecord body) {
